...
<div class="card card-xxl-stretch h-100 bgi-no-repeat" style="background-color: #020c05; background-position: 0 calc(100% + 0.5rem); background-size: 100% auto; background-image:url('/templates/<?=getenv('app.template.dashboard')?>/assets/media/svg/general/rhone.svg')">
	<!--begin::Body-->
	<div class="card-body">
